...
/* harmony import */ var _modules_init_feedback_form__WEBPACK_IMPORTED_MODULE_2__ = __webpack_require__(/*! ./modules/init-feedback-form */ "./js/modules/init-feedback-form.js");
/* harmony import */ var _modules_init_accordion__WEBPACK_IMPORTED_MODULE_3__ = __webpack_require__(/*! ./modules/init-accordion */ "./js/modules/init-accordion.js");
...
window.addEventListener('DOMContentLoaded', function () {
  ...
  window.addEventListener('load', function () {
    Object(_modules_modals_init_modals__WEBPACK_IMPORTED_MODULE_1__["initModals"])(); // initCustomSelect();
    // initFormValidate();

    Object(_modules_init_feedback_form__WEBPACK_IMPORTED_MODULE_2__["initFeedbackForm"])();
    Object(_modules_init_accordion__WEBPACK_IMPORTED_MODULE_3__["initAccordions"])();
  });
}); // ---------------------------------
...
/***/ "./js/modules/init-feedback-form.js":
/*!******************************************!*\
  !*** ./js/modules/init-feedback-form.js ***!
  \******************************************/
/*! exports provided: initFeedbackForm */
/***/ (function(module, __webpack_exports__, __webpack_require__) {

"use strict";
__webpack_require__.r(__webpack_exports__);
/* harmony export (binding) */ __webpack_require__.d(__webpack_exports__, "initFeedbackForm", function() { return initFeedbackForm; });
var initFeedbackForm = function initFeedbackForm() {
  var formItems = document.querySelectorAll('[data-form="input"], [data-form="textarea"]');
  var textAreas = document.querySelectorAll('[data-form="textarea"]');
  ...
  formItems.forEach(function (item) {
    ...
    var itemLabel = itemParent.querySelector('[data-form="label"]');

    var checkValueLength = function checkValueLength() {
  ...
  textAreas.forEach(function (item) {
    var itemParent = item.parentNode;
    var itemCounter = itemParent.querySelector('[data-form="counter"]');

    if (itemCounter) {
      itemCounter.textContent = "".concat(item.maxLength - item.value.length);
